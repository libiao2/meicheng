...
class AddFoodInfo extends Component {
  ...
  deleteChooseImg(index) {
    const { chooseGoodsImgList } = this.state;
    let newList = [...chooseGoodsImgList];
  ...
  goAddFood() {
    ...
    let obj = {
      picList: [...picList, ...chooseGoodsImgList],
      name,
      detail,
      price,
      foodImg
      ...
      <View className='container'>
        <AtForm>
          <View className='shopImgBox'>
            ...
            {
              chooseGoodsImgList.length > 0 &&
              <View className='chooseImgList'>
                {
                  chooseGoodsImgList.map((item,index) => {
                    return (
