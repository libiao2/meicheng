...
class ChangeAddHome extends Component {
  config = {
  ...
  deleteChooseImg(index) {
    const { changeHomeImgList } = this.state;
    let newList = [...changeHomeImgList];
  ...
  submitForm() {
    ...
    let obj = {
      ...
      categoryId: 5,
      verifyStatus: 0,
      picList: [...changeHomeImgList, ...picList],
      name,
      city,
      address,
      price,
  ...
  render () {
    const { typeChoose, changeHomeImgList } = this.state;
    return (
      <View className='container'>
        <AtForm>
          <View className='shopImgBox'>
            ...
            {
              changeHomeImgList.length > 0 &&
              <View className='chooseImgList'>
                {
                  changeHomeImgList.map((item,index) => {
                    return (
