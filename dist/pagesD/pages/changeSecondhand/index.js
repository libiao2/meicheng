(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pagesD/pages/changeSecondhand/index"],{

/***/ "./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=script&parse=PAGE&":
/*!**********************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=script&parse=PAGE& ***!
  \**********************************************************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.less */ "./src/pagesD/pages/changeSecondhand/index.less");
...
var ChangeSecondhand = (_dec = (0, _redux.connect)(function (_ref) {
  ...
  _inherits(ChangeSecondhand, _BaseComponent);
  ...
  function ChangeSecondhand() {
    ...
    _classCallCheck(this, ChangeSecondhand);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = ChangeSecondhand.__proto__ || Object.getPrototypeOf(ChangeSecondhand)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["loopArray142", "loopArray143", "loopArray144", "$compid__384", "$compid__385", "$compid__386", "$compid__387", "$compid__388", "$compid__389", "$compid__390", "$compid__391", "ershouImgList", "typeChoose", "imgList", "picList", "name", "isOpencity", "cityName", "city", "address", "price", "detail", "note", "weixinno", "telephone", "email", "isOpen", "toast", "areaList", "typeList", "longitude", "latitude", "id"], _this.config = {
  ...
  _createClass(ChangeSecondhand, [{
    key: '_constructor',
    value: function _constructor(props) {
      _get(ChangeSecondhand.prototype.__proto__ || Object.getPrototypeOf(ChangeSecondhand.prototype), '_constructor', this).call(this, props);
      this.state = {
        imgList: {
          files: [],
          showUploadBtn: true,
    ...
    value: function deleteChooseImg(index) {
      var ershouImgList = this.state.ershouImgList;

      var newList = [].concat(_toConsumableArray(ershouImgList));
    ...
    value: function submitForm() {
      var _state = this.state,
          ...
          ershouImgList = _state.ershouImgList;
      ...
      var obj = {
        ...
        categoryId: 4,
        verifyStatus: 0,
        picList: [].concat(_toConsumableArray(ershouImgList), _toConsumableArray(picList)),
        name: name,
        city: city,
        address: address,
        price: price,
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _taroWeapp.genCompid)(__prefix + "$compid__384"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__384 = _genCompid2[0],
          $compid__384 = _genCompid2[1];

      var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + "$compid__385"),
          _genCompid4 = _slicedToArray(_genCompid3, 2),
          $prevCompid__385 = _genCompid4[0],
          $compid__385 = _genCompid4[1];

      var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + "$compid__386"),
          _genCompid6 = _slicedToArray(_genCompid5, 2),
          $prevCompid__386 = _genCompid6[0],
          $compid__386 = _genCompid6[1];

      var _genCompid7 = (0, _taroWeapp.genCompid)(__prefix + "$compid__387"),
          _genCompid8 = _slicedToArray(_genCompid7, 2),
          $prevCompid__387 = _genCompid8[0],
          $compid__387 = _genCompid8[1];

      var _genCompid9 = (0, _taroWeapp.genCompid)(__prefix + "$compid__388"),
          _genCompid10 = _slicedToArray(_genCompid9, 2),
          $prevCompid__388 = _genCompid10[0],
          $compid__388 = _genCompid10[1];

      var _genCompid11 = (0, _taroWeapp.genCompid)(__prefix + "$compid__389"),
          _genCompid12 = _slicedToArray(_genCompid11, 2),
          $prevCompid__389 = _genCompid12[0],
          $compid__389 = _genCompid12[1];

      var _genCompid13 = (0, _taroWeapp.genCompid)(__prefix + "$compid__390"),
          _genCompid14 = _slicedToArray(_genCompid13, 2),
          $prevCompid__390 = _genCompid14[0],
          $compid__390 = _genCompid14[1];

      var _genCompid15 = (0, _taroWeapp.genCompid)(__prefix + "$compid__391"),
          _genCompid16 = _slicedToArray(_genCompid15, 2),
          $prevCompid__391 = _genCompid16[0],
          $compid__391 = _genCompid16[1];

      var _state2 = this.__state,
          typeChoose = _state2.typeChoose,
          ershouImgList = _state2.ershouImgList;
      ...
      var loopArray142 = ershouImgList.length > 0 ? ershouImgList.map(function (item, index) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "biazz" + index;
      ...
      var loopArray143 = this.__state.areaList.map(function (item, index) {
        ...
        var _$indexKey2 = "bibzz" + index;

        _this5.anonymousFunc3Map[_$indexKey2] = function () {
          return _this5.selectCity(item.$original);
        };

        var _genCompid17 = (0, _taroWeapp.genCompid)(__prefix + 'bidzzzzzzz' + index, true),
            _genCompid18 = _slicedToArray(_genCompid17, 2),
            $prevCompid__383 = _genCompid18[0],
            $compid__383 = _genCompid18[1];
  ...
  return ChangeSecondhand;
}(_taroWeapp.Component), _class2.$$events = ["anonymousFunc0", "nameChange", "anonymousFunc1", "anonymousFunc4", "areaNameChange", "priceChange", "phoneChange", "weixinnoChange", "emailChange", "anonymousFunc5"], _class2.$$componentPath = "pagesD/pages/changeSecondhand/index", _temp2)) || _class);
exports.default = ChangeSecondhand;

Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/_@tarojs_taro-weapp@2.0.6@@tarojs/taro-weapp/index.js").default.createComponent(ChangeSecondhand, true));

/***/ }),

/***/ "./node_modules/_file-loader@4.3.0@file-loader/dist/cjs.js?name=[path][name].wxml&context=/Volumes/libiao/Project2020/lifeXCX/uslife-xcx/src!./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=template&parse=PAGE&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/_file-loader@4.3.0@file-loader/dist/cjs.js?name=[path][name].wxml&context=/Volumes/libiao/Project2020/lifeXCX/uslife-xcx/src!./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/_@tarojs_mini-runner@2.0.6@@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=template&parse=PAGE& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "pagesD/pages/changeSecondhand/index.wxml";

/***/ }),

/***/ "./src/pagesD/pages/changeSecondhand/index.jsx":
/*!*****************************************************!*\
  !*** ./src/pagesD/pages/changeSecondhand/index.jsx ***!
  \*****************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=script&parse=PAGE&":
/*!**********************************************************************************!*\
  !*** ./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=script&parse=PAGE& ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=template&parse=PAGE&":
/*!************************************************************************************!*\
  !*** ./src/pagesD/pages/changeSecondhand/index.jsx?taro&type=template&parse=PAGE& ***!
  \************************************************************************************/
/*! no static exports found */
...
/***/ "./src/pagesD/pages/changeSecondhand/index.less":
/*!******************************************************!*\
  !*** ./src/pagesD/pages/changeSecondhand/index.less ***!
  \******************************************************/
/*! no static exports found */
...
},[["./src/pagesD/pages/changeSecondhand/index.jsx","runtime","taro","vendors","common"]]]);